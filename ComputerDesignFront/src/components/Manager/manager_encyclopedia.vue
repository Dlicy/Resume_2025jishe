  ...
  <div class="drug-form-grid">
    ...
    <div class="form-column">
      <div class="form-group">
        ...
        <input v-model="newDrug.drugCategories" id="drug-categories" type="text" class="form-input" required>
      </div>
      
      <div class="form-group">
        <label for="main-name">药物名称</label>
        <input v-model="newDrug.mainName" id="main-name" type="text" class="form-input" required>
      </div>
      
      <div class="form-group">
        <label for="nature-flavor">药物性味</label>
        <input v-model="newDrug.natureAndFlavor" id="nature-flavor" type="text" class="form-input">
      </div>
      ...
      <div class="form-group">
        ...
        <input v-model="newDrug.indications" id="indications" type="text" class="form-input">
      </div>
    </div>
    ...
    <div class="form-column">
      <div class="form-group">
        ...
        <input v-model="newDrug.drugCategory" id="drug-category" type="text" class="form-input">
      </div>
    ...
    <div class="form-column">
      ...
      <div class="form-group">
        ...
        <input v-model="newDrug.contraindications" id="contraindications" type="text" class="form-input">
      </div>
...
<style scoped>
        ...
        .page-button:hover, .delete-button:hover {
            background-color: #0f3460;
        }
        .page-button.active {
            background-color: #0f3460;
